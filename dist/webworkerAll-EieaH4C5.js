import { E as m, U as lt, T as de, b as ct, a4 as T, a5 as R, v as w, ae as he, _ as W, af as O, Q as dt, o as Y, ag as ht, ah as fe, $ as Se, ai as E, aj as ft, ak as S, w as X, G as Pe, a as Fe, M as B, n as D, i as Be, I as P, a7 as ie, R as se, H as Re, h as I, B as F, D as ne, c as k, z as K, al as pt, am as ae, L as te, an as V, S as oe, p as Ue, s as Me, a9 as Ge, ab as ze, q as gt, t as mt, aa as xt, ac as _t, ad as yt, ao as bt, ap as vt, aq as N, e as v, ar as Tt } from "./index-CbUjW4XO.js";
import { F as wt, S as $, c as j, a as Ct, b as St, B as Ae } from "./colorToUniform-Dy_GZxOz.js";
class ke {
  /**
  ...
  static init(e) {
    e = Object.assign({
      ...
      "ticker",
      {
        configurable: !0,
        set(t) {
          this._ticker && this._ticker.remove(this.render, this), this._ticker = t, t && t.add(this.render, this, lt.LOW);
        },
        get() {
          return this._ticker;
        }
...
const Oe = class Ie extends Pt {
  ...
  ensureCharacters(e) {
    const t = O.graphemeSegmenter(e).filter((x) => !this._currentChars.includes(x)).filter((x, p, g) => g.indexOf(x) === p);
    if (!t.length)
      return;
    ...
    for (let x = 0; x < t.length; x++) {
      const p = t[x], g = O.measureText(p, a, i, !1);
      g.lineHeight = g.height;
      const b = g.width * c, C = Math.ceil((a.fontStyle === "italic" ? 2 : 1) * b), M = g.height * c, U = C + h * 2, G = M + h * 2;
      if (f = !1, p !== `
` && p !== "\r" && p !== "	" && p !== " " && (f = !0, d = Math.ceil(Math.max(G, d))), u + U > y && (l += d, d = G, u = 0, l + d > _)) {
        n.update();
        const A = this._nextPage();
        i = A.canvasAndContext.canvas, s = A.canvasAndContext.context, n = A.texture.source, u = 0, l = 0, d = 0;
      }
      const z = b / c - (a.dropShadow?.distance ?? 0) - (a._stroke?.width ?? 0);
      if (this.chars[p] = {
        id: p.codePointAt(0),
        ...
        const A = n.width * c, ce = n.height * c, ut = new dt(
          u / A * n.width,
          l / ce * n.height,
          U / A * n.width,
          G / ce * n.height
  ...
  _drawGlyph(e, t, r, i, s, n) {
    const a = t.text, u = t.fontProperties, d = (n._stroke?.width ?? 0) * s, c = r + d / 2, h = i - d / 2, f = u.descent * s, y = t.lineHeight * s;
    let _ = !1;
...
function We(o, e, t, r) {
  ...
  const u = {
    ...
    s.width += p.width, a = !1, u.width = 0, u.index = 0, u.chars.length = 0;
  }, _ = () => {
    let p = s.chars.length - 1;
    if (r) {
      let g = s.chars[p];
      for (; g === " "; )
        s.width -= t.chars[g].xAdvance, g = s.chars[--p];
    }
...
`)
  ...
  return _(), e.align === "center" ? Ft(i) : e.align === "right" ? Bt(i) : e.align === "justify" && Rt(i), i;
}
function Ft(o) {
...
class Mt {
  ...
  getFont(e, t) {
    ...
    if (t._fill.fill && !t._stroke ? (r += t._fill.fill.styleKey, i = !1) : (t._stroke || t.dropShadow) && (r = `${t.styleKey}-bitmap`, i = !1), !S.has(r)) {
      ...
      L++, L > 50 && X("BitmapText", `You have dynamically created ${L} bitmap fonts, this can be inefficient. Try pre installing your font styles using \`BitmapFont.install({name:"style1", style})\``), a.once("destroy", () => {
        L--, S.remove(r);
      }), S.set(
        r,
        a
  ...
  getLayout(e, t, r = !0) {
    ...
    const n = O.graphemeSegmenter(e), a = We(n, t, i, r);
  ...
  install(...e) {
    ...
    const i = t.style, s = i instanceof E ? i : new E(i), n = t.dynamicFill ?? this._canUseTintForStyle(s), a = new pe({
      style: s,
      overrideFill: n,
    ...
    return a.ensureCharacters(u.join("")), S.set(`${r}-bitmap`, a), a.once("destroy", () => S.remove(`${r}-bitmap`)), a;
  }
  /**
...
function Dt(o, e) {
  ...
  for (let r = 0; r < o.length; r++) {
    ...
    s?.isCachedAsTexture ? e.matrix = me.copyFrom(s.textureOffsetInverseTransform).append(i.worldTransform) : s?._parentCacheAsTextureRenderGroup ? e.matrix = me.copyFrom(s._parentCacheAsTextureRenderGroup.inverseWorldTransform).append(i.groupTransform) : e.matrix = i.worldTransform, e.addBounds(i.bounds);
  }
  return e.matrix = t, e;
}
const Ot = new ie({
...
class Ve {
  ...
  generateFilteredTexture({ texture: e, filters: t }) {
    ...
    this._calculateGlobalFrame(
      ...
      i.width,
      i.height
    ), r.outputRenderSurface = P.getOptimalTexture(
      a.width,
      a.height,
      r.resolution,
      r.antialias
  ...
  getBackTexture(e, t, r) {
    const i = e.colorTexture.source._resolution, s = P.getOptimalTexture(
      t.width,
      t.height,
      i,
      !1
  ...
  calculateSpriteMatrix(e, t) {
    const r = this._activeFilterData, i = e.set(
      ...
      r.bounds.minX,
      r.bounds.minY
    ), s = t.worldTransform.copyTo(B.shared), n = t.renderGroup || t.parentRenderGroup;
  ...
  _getPassthroughFilter() {
    return this._passthroughFilter ?? (this._passthroughFilter = new kt()), this._passthroughFilter;
  }
  /**
  ...
  _setupFilterTextures(e, t, r, i) {
    if (e.backTexture = w.EMPTY, e.inputTexture = P.getOptimalTexture(
      t.width,
      t.height,
      e.resolution,
      e.antialias
  ...
  _calculateFilterArea(e, t) {
    if (e.renderables ? Dt(e.renderables, t) : e.filterEffect.filterArea ? (t.clear(), t.addRect(e.filterEffect.filterArea), t.applyMatrix(e.container.worldTransform)) : e.container.getFastGlobalBounds(!0, t), e.container) {
  ...
  _applyFiltersToTexture(e, t) {
    ...
    if (this._globalFilterBindGroup.setResource(r.source.style, 2), this._globalFilterBindGroup.setResource(e.backTexture.source, 3), n === a)
      ...
      s[a].apply(this, u, e.outputRenderSurface, t), P.returnTexture(l);
    }
  }
  _calculateFilterBounds(e, t, r, i, s) {
    const n = this.renderer, a = e.bounds, u = e.filters;
    let l = 1 / 0, d = 0, c = !0, h = !1, f = !1, y = !0, _ = -1, x = -1;
    for (let p = 0; p < u.length; p++) {
      const g = u[p];
      if (!g.enabled)
        continue;
      if (_ === -1 && (_ = p), x = p, l = Math.min(l, g.resolution === "inherit" ? i : g.resolution), d += g.padding, g.antialias === "off" ? c = !1 : g.antialias === "inherit" && c && (c = r), g.clipToViewport || (y = !1), !!!(g.compatibleRenderers & n.type)) {
        f = !1;
        break;
      }
  ...
  _pushFilterData() {
    ...
    return e || (e = this._filterStack[this._filterStackIndex] = new It()), this._filterStackIndex++, e;
  }
}
Ve.extension = {
  type: [
...
class Xe {
  constructor(e, t) {
    this.state = $.for2d(), this.renderer = e, this._adaptor = t, this.renderer.runners.contextChange.add(this), this._managedGraphics = new k({ renderer: e, type: "renderable", priority: -1, name: "graphics" });
  }
  contextChange() {
...
class je {
  ...
  addRenderable(e, t) {
    ...
    if (e.didViewUpdate && (i.indexSize = e._geometry.indices?.length, i.vertexSize = e._geometry.positions?.length), i.batched) {
...
class Ne {
   ...
   */
  constructor(e, t) {
    this.state = $.for2d(), this.localUniforms = new D({
      uTranslationMatrix: { value: new B(), type: "mat3x3<f32>" },
      uColor: { value: new Float32Array(4), type: "vec4<f32>" },
      uRound: { value: 1, type: "f32" },
      uResolution: { value: [0, 0], type: "vec2<f32>" }
    }), this.renderer = e, this.adaptor = t, this.defaultShader = new Nt(), this.state = $.for2d(), this._managedContainers = new k({ renderer: e, type: "renderable", name: "particleContainer" });
  }
  validateRenderable(e) {
    return !1;
  }
  ...
  execute(e) {
    ...
    e.worldTransform.copyTo(a), a.prepend(r.globalUniforms.globalUniformData.projectionMatrix), n.uResolution = r.globalUniforms.globalUniformData.resolution, n.uRound = r._roundPixels | e._roundPixels, j(
      e.groupColorAlpha,
      n.uColor,
      0
...
const Je = class Ze extends Vt {
  ...
  updatePositions() {
    const e = this.positions, {
      ...
      _anchorX: u,
      _anchorY: l
    } = this, d = i + s, c = t > d ? 1 : t / d, h = n + a, f = r > h ? 1 : r / h, y = Math.min(c, f), _ = u * t, x = l * r;
...
class et {
  constructor(e) {
    this._renderer = e, this._managedSprites = new k({ renderer: e, type: "renderable", name: "nineSliceSprite" });
  }
  addRenderable(e, t) {
...
function sr(o, e) {
  ...
  const a = B.shared;
  a.copyFrom(o._tileTransform.matrix), a.tx /= o.width, a.ty /= o.height, a.invert(), a.scale(o.width / r, o.height / i), ir(e, 2, 0, a);
}
const H = new tr();
class nr {
  constructor() {
...
class tt {
  constructor(e) {
    this._state = $.default2d, this._renderer = e, this._managedTilingSprites = new k({ renderer: e, type: "renderable", name: "tilingSprite" });
  }
  validateRenderable(e) {
  ...
  addRenderable(e, t) {
    ...
    if (n) {
      ...
      r.break(t), i.shader || (i.shader = new er()), this.updateRenderable(e), t.add(e);
  }
  execute(e) {
  ...
  _updateBatchableMesh(e) {
    ...
    i.addressMode !== "repeat" && (i.addressMode = "repeat", i.update()), sr(e, r.uvs), rr(e, r.positions);
  }
  destroy() {
...
class rt {
  constructor(e) {
    this._renderer = e, this._managedBitmapTexts = new k({ renderer: e, type: "renderable", priority: -2, name: "bitmapText" });
  }
  validateRenderable(e) {
  ...
  _updateContext(e, t) {
    const { context: r } = t, i = Gt.getFont(e.text, e._style);
    r.clear(), i.distanceField.type !== "none" && (r.customShader || (r.customShader = new cr(this._renderer.limits.maxBatchableTextures)));
    ...
    for (let p = 0; p < u.lines.length; p++) {
      ...
      for (let b = 0; b < g.charPositions.length; b++) {
        const C = g.chars[b], M = i.chars[C];
        if (M?.texture) {
          const U = M.texture;
          r.texture(
            U,
            f || "black",
            Math.round(g.charPositions[b] + M.xOffset),
            Math.round(a + M.yOffset + x),
            U.orig.width,
            U.orig.height
          );
        }
  ...
  _updateDistanceField(e) {
    const t = this._getGpuBitmapText(e).context, r = e._style.fontFamily, i = S.get(`${r}-bitmap`), { a: s, b: n, c: a, d: u } = e.groupTransform, l = Math.sqrt(s * s + n * n), d = Math.sqrt(a * a + u * u), c = (Math.abs(l) + Math.abs(d)) / 2, h = i.baseRenderedFontSize / e._style.fontSize, f = c * i.distanceField.range * (1 / h);
...
class it {
  constructor(e) {
    this._renderer = e, e.runners.resolutionChange.add(this), this._managedTexts = new k({
      renderer: e,
      type: "renderable",
  ...
  initGpuText(e) {
    const t = new hr();
    return t.renderable = e, t.transform = e.groupTransform, t.texture = w.EMPTY, t.bounds = { minX: 0, maxX: 1, minY: 0, maxY: 0 }, t.roundPixels = this._renderer._roundPixels | e._roundPixels, e._resolution = e._autoResolution ? this._renderer.resolution : e.resolution, e._gpuData[this._renderer.uid] = t, this._managedTexts.add(e), t;
  }
  onTextUnload(e) {
...
async function _r(o) {
  const e = o.filter((t) => S.has(`${t}-and-url`)).map((t) => {
    if (!ee.has(t)) {
      const { entries: r } = S.get(`${t}-and-url`), i = [];
      r.forEach((s) => {
...
class nt {
  ...
  async _buildTexturePromise(e) {
    const { text: t, style: r, resolution: i, textureStyle: s } = e, n = K.get(Ye), a = gr(t, r), u = await _r(a), l = Wt(t, r, u, n), d = Math.ceil(Math.ceil(Math.max(1, l.width) + r.padding * 2) * i), c = Math.ceil(Math.ceil(Math.max(1, l.height) + r.padding * 2) * i), h = n.image, f = 2;
    h.width = (d | 0) + f, h.height = (c | 0) + f;
    const y = yr(t, r, i, u, n);
    await vr(h, y, fr() && a.length > 0);
    const _ = h;
    let x;
    this._createCanvas && (x = br(h, i));
    const p = st(
      x ? x.canvas : _,
      h.width - f,
      h.height - f,
    ...
    return s && (p.source.style = s), this._createCanvas && (this._renderer.texture.initSource(p.source), Y.returnCanvasAndContext(x)), K.return(n), p;
  }
  ...
  _cleanUp(e) {
    P.returnTexture(e, !0), e.source.resource = null, e.source.uploadMethodId = "unknown";
  }
  destroy() {
    this._renderer = null;
...
class ot {
  ...
  returnTexture(e) {
    const t = e.source;
    t.resource = null, t.uploadMethodId = "unknown", t.alphaMode = "no-premultiply-alpha", P.returnTexture(e, !0);
  }
  /**
